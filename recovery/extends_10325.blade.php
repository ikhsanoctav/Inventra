@extends('layouts.app')
2: 
3: @section('header_title', 'Barang Masuk')
4: 
...
9:         <div>
10:             <h2 class="font-headline text-2xl font-bold text-[#111827]">Barang Masuk</h2>
11:             <p class="text-sm text-[#6B7280]">Kelola dan pantau informasi barang masuk dalam sistem logistik.</p>
12:         </div>
13:         
...
31:                     <tr>
32:                         <th scope="col" class="px-6 py-4">No. Referensi</th>
                        <th scope="col" class="px-6 py-4">Tanggal</th>
                        <th scope="col" class="px-6 py-4">Supplier</th>
                        <th scope="col" class="px-6 py-4">Total Item</th>
                        <th scope="col" class="px-6 py-4">Status Penerimaan</th>
...
43:                                 </div>
44:                                 <h3 class="text-sm font-semibold text-[#111827] mb-1">Belum ada barang masuk</h3>
...
89:                         <h3 class="text-lg font-headline font-bold text-[#111827]" id="modal-title">Tambah Barang Masuk</h3>
...
97:                         
98:                         <div>
99:                             <label class="block text-xs font-semibold text-[#374151] mb-1.5">No. Referensi</label>
100:                             <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 transition-all" placeholder="Masukkan no. referensi...">
101:                         </div>
102:                         <div>
...
105:                         </div>
106:                         <div>
107:                             <label class="block text-xs font-semibold text-[#374151] mb-1.5">Supplier</label>
108:                             <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 transition-all" placeholder="Masukkan supplier...">
109:                         </div>
110:                         <div>
...
113:                         </div>
114:                         <div>
115:                             <label class="block text-xs font-semibold text-[#374151] mb-1.5">Status Penerimaan</label>
116:                             <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 transition-all" placeholder="Masukkan status penerimaan...">
117:                         </div>
118:                         
