...
@section('header_title', 'Detail Barang Keluar')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2 mb-1">
                <a href="{{ route('transactions.outbound') }}" class="text-[#6B7280] hover:text-[#111827] transition-colors"><span class="material-symbols-outlined text-[20px]">arrow_back</span></a>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-[#E5E7EB] shadow-sm overflow-hidden flex flex-col h-full">
            <div class="p-5 border-b border-[#E5E7EB] flex items-center justify-between">
                <h3 class="font-semibold text-[#111827]">Daftar Item Keluar</h3>
            </div>
                    ...
                    <tbody class="divide-y divide-[#E5E7EB]">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <form action="{{ route('transactions.outbound.lines.destroy', $line->id) }}" method="POST" onsubmit="return confirm('Hapus item ini?');">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm overflow-hidden h-fit">
            <div class="p-5 border-b border-[#E5E7EB]">
                <h3 class="font-semibold text-[#111827]">Tambah Item Keluar</h3>
            </div>
            <div class="p-5">
