    ...
    <div class="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm overflow-hidden">
        <table class="w-full text-left text-sm text-[#4B5563]">
            <thead class="bg-[#F8FAFC] text-xs uppercase text-[#6B7280] font-semibold border-b border-[#E5E7EB]">
                <tr>
                    <th scope="col" class="px-6 py-4">No. Keluar</th>
                    <th scope="col" class="px-6 py-4">Tanggal</th>
                    <th scope="col" class="px-6 py-4">Tujuan</th>
                    <th scope="col" class="px-6 py-4 text-center">Total Item</th>
                    <th scope="col" class="px-6 py-4 text-center">Status Pengiriman</th>
            ...
            <tbody class="divide-y divide-[#E5E7EB]">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        <span class="material-symbols-outlined text-3xl text-[#D1D5DB] mb-3">outbox</span>
                        <h3 class="text-sm font-semibold text-[#111827] mb-1">Belum ada transaksi outbound</h3>
                    </td>
                </tr>
                @endforelse
            </tbody>
