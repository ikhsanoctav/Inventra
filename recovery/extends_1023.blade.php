@extends('layouts.app')
2: 
3: @section('header_title', 'Pengaturan Sistem')
4: 
...
8:         <div>
9:             <h2 class="font-headline text-xl font-bold text-[#111827]">Pengaturan Sistem</h2>
10:             <p class="text-sm text-[#6B7280]">Halaman untuk mengelola pengaturan sistem.</p>
11:         </div>
...
18:         Modul Pengaturan Sistem belum diimplementasikan.
19:     </div>
20: </div>
21: @endsection