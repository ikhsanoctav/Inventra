@extends('layouts.app')
2: 
3: @section('header_title', 'Satuan Barang')
4: 
...
9:         <div>
10:             <h2 class="font-headline text-2xl font-bold text-[#111827]">Satuan Barang</h2>
11:             <p class="text-sm text-[#6B7280]">Kelola dan pantau informasi satuan barang dalam sistem logistik.</p>
12:         </div>
13:         
...
31:                     <tr>
32:                         <th scope="col" class="px-6 py-4">Nama Satuan</th>
...
38:                     <tr>
39:                         <td colspan="4" class="px-6 py-12 text-center">
...
43:                                 </div>
44:                                 <h3 class="text-sm font-semibold text-[#111827] mb-1">Belum ada satuan barang</h3>
...
89:                         <h3 class="text-lg font-headline font-bold text-[#111827]" id="modal-title">Tambah Satuan Barang</h3>
...
97:                         
98:                         <div>
99:                             <label class="block text-xs font-semibold text-[#374151] mb-1.5">Nama Satuan</label>
100:                             <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 transition-all" placeholder="Masukkan nama satuan...">
101:                         </div>
102:                         <div>
103:                             <label class="block text-xs font-semibold text-[#374151] mb-1.5">Singkatan</label>
104:                             <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 transition-all" placeholder="Masukkan singkatan...">
105:                         </div>
106:                         <div>
107:                             <label class="block text-xs font-semibold text-[#374151] mb-1.5">Keterangan</label>
108:                             <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 transition-all" placeholder="Masukkan keterangan...">
109:                         </div>
110:                         
111:                         <div class="mt-6 sm:flex sm:flex-row-reverse gap-2 pt-4 border-t border-[#E5E7EB]">
112:                             <button type="button" class="inline-flex w-full justify-center rounded-lg bg-[#F97316] px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#EA580C] sm:w-auto transition-colors">
113:                                 Simpan Data
114:                             </button>
115:                             <button @click="showModal = false" type="button" class="mt-3 inline-flex w-full justify-center rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-[#111827] shadow-sm ring-1 ring-inset ring-[#D1D5DB] hover:bg-gray-50 sm:mt-0 sm:w-auto transition-colors">
116:                                 Batal
117:                             </button>
118:                         </div>
119:                     </form>
...
124: </div>
125: 
126: <!-- Add Alpine.js for simple modal state management without writing custom JS -->
127: <script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script>
128: @endsection