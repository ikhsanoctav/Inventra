...
22:             </div>
23:             <div>
24:                 <h3 class="font-headline text-2xl font-bold text-[#111827]">14.820 <span class="text-sm font-normal text-[#9CA3AF]">Item</span></h3>
25:                 <p class="text-[11px] text-emerald-600 font-medium flex items-center gap-1 mt-1">
26:                     <span class="material-symbols-outlined text-[14px]">trending_up</span> +5.2% MoM
27:                 </p>
28:             </div>
29:         </div>
30: 
...
35:                 <div class="w-8 h-8 rounded-lg bg-orange-50 text-[#F97316] flex items-center justify-center">
36:                     <span class="material-symbols-outlined text-[18px]">inventory</span>
37:                 </div>
38:             </div>
39:             <div>
40:                 <h3 class="font-headline text-2xl font-bold text-[#111827]">489.120 <span class="text-sm font-normal text-[#9CA3AF]">Unit</span></h3>
41:                 <div class="w-full bg-gray-100 rounded-full h-1.5 mt-2">
42:                     <div class="bg-[#F97316] h-1.5 rounded-full" style="width: 92%"></div>
43:                 </div>
44:                 <p class="text-[10px] text-[#9CA3AF] mt-1 text-right">92% Kapasitas Gudang</p>
45:             </div>
46:         </div>
47: 
48:         <!-- Stat 3 -->
...
55:             </div>
56:             <div>
57:                 <h3 class="font-headline text-2xl font-bold text-[#111827]">64 <span class="text-sm font-normal text-[#9CA3AF]">Vendor</span></h3>
58:                 <p class="text-[11px] text-emerald-600 font-medium flex items-center gap-1 mt-1">
59:                     <span class="material-symbols-outlined text-[14px]">verified</span> 98% SLA On-Time
60:                 </p>
61:             </div>
62:         </div>
63: 
...
71:             </div>
72:             <div>
73:                 <h3 class="font-headline text-2xl font-bold text-red-600">18 <span class="text-sm font-normal text-[#9CA3AF]">Kritis</span></h3>
74:                 <p class="text-[11px] text-[#6B7280] font-medium flex items-center gap-1 mt-1">
75:                     142 Menipis, 34 Kadaluarsa
76:                 </p>
77:             </div>
78:         </div>
79:     </div>
