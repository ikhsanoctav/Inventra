...
@section('header_title', 'Rekanan Supplier')
...
<div class="space-y-6" x-data="{ showModal: false }">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        <div class="min-w-[200px] flex-1">
            <h2 class="font-headline text-2xl font-bold text-[#111827] leading-tight">Rekanan Supplier</h2>
            <p class="text-sm text-[#6B7280] mt-1">Kelola dan pantau informasi rekanan supplier dalam sistem logistik.</p>
        </div>
    ...
    <!-- Filter Section -->
    <form method="GET" action="{{ route('master.suppliers') }}" 
          hx-get="{{ route('master.suppliers') }}"
        ...
        <div class="flex-1 min-w-[200px] w-full sm:w-auto">
            <label class="block text-xs font-semibold text-slate-700 mb-1">Cari Supplier</label>
            <div class="relative">
            ...
            <table class="w-full text-left text-sm text-[#4B5563]">
                <thead class="bg-[#F8FAFC] text-xs uppercase text-[#6B7280] font-semibold border-b border-[#E5E7EB]">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 whitespace-nowrap">Nama Perusahaan</th>
                        <th scope="col" class="px-6 py-4 whitespace-nowrap">Kontak</th>
                        <th scope="col" class="px-6 py-4 whitespace-nowrap">Email</th>
                        <th scope="col" class="px-6 py-4 whitespace-nowrap">Status Kontrak</th>
                ...
                <tbody class="divide-y divide-[#E5E7EB]">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 font-medium text-[#111827]">{{ $supplier->name }}</td>

                        <td class="px-6 py-4 text-[#6B7280]">{{ $supplier->contact_person ?? '-' }}<br><span class="text-xs">{{ $supplier->phone }}</span></td>

                        <td class="px-6 py-4 text-[#6B7280]">{{ $supplier->email ?? '-' }}</td>

                        <td class="px-6 py-4">

                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $supplier->status == 'active' ? 'bg-emerald-100 text-emerald-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    <tr>
                        ...
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-sm font-semibold text-[#111827] mb-1">Belum ada rekanan supplier</h3>
            ...
            <div x-show="showModal" 
                ...
                <div class="bg-white px-6 pb-6 pt-6">
                    ...
                    <div class="flex items-center justify-between mb-5 border-b border-[#E5E7EB] pb-4">
                        ...
                        <h3 class="text-lg font-headline font-bold text-[#111827]" id="modal-title">Tambah Rekanan Supplier</h3>
                    ...
                    <form action="{{ route('master.suppliers') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 transition-all" name="name" required placeholder="Masukkan nama perusahaan...">

                        </div>

                        <div>

                            <label class="block text-xs font-semibold text-[#374151] mb-1.5">Kontak</label>

                            <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 transition-all" name="contact_person" placeholder="Masukkan kontak person...">
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 transition-all" name="email" type="email" placeholder="Masukkan email...">

                        </div>

                        <div>

                            <label class="block text-xs font-semibold text-[#374151] mb-1.5">Status Kontrak</label>

                            <input type="text" class="w-full h-10 px-3 text-sm bg-white border border-[#D1D5DB] rounded-lg text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 transition-all" name="phone" placeholder="Masukkan nomor telepon...">
